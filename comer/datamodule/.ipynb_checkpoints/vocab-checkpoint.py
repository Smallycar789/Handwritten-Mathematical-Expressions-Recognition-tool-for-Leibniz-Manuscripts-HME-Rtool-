...
class LHVocab:
    ...
    def __init__(self, dict_path: str = default_dict()) -> None:
        self.word2idx = dict()
        self.word2idx["<pad>"] = self.PAD_IDX  #padding
        self.word2idx["<sos>"] = self.SOS_IDX  #start of sequence
        self.word2idx["<eos>"] = self.EOS_IDX  #end of sequence
    ...
    def indices2words(self, id_list: List[int]) -> List[str]:
        ...
        #return [self.idx2word[i] if i in self.idx2word else "<unk>" for i in id_list]
